...
parser.add_argument('--chunk-length', type=int, default=1)
...
for line in sys.stdin:
    long = line.startswith("<longgen>")
    if long:
        line = line[9:]
    print(" ".join(predict(dataset, model, text=line.rstrip(), next_words=(args.chunk_length, 1000)[long])[100:]))
