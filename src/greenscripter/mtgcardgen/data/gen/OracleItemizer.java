	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i < 1; i++) {
			...
			for (CleanedCard card : cards) {
				//				String[] letters = card.name.toLowerCase().replace(" ", "-").split("");
				...
				sb.append(" ****2 ");
				sb.append(card.oracle);
				sb.append(" ****3 ");
				sb.append((card.size == null ? "" : card.size).replace("/", " / "));
				sb.append(" ****4 ");
				//			sb.append(" ****5 ");
		...
		Utils.save(outlines, new File("cardoracle.txt"));
